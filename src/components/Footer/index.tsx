        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                Burdubai, Dubai, United Arab Emirates.
              </li>
          ...
          <div className="w-full sm:w-auto">
            <div className="flex items-center gap-3 mb-4 lg:justify-end">
              ...
              />
              <h2 className="text-custom-1 font-serif font-semibold text-dark lg:text-right">
                Global Supply 600
              </h2>
            </div>

            <p className="lg:text-right text-custom-sm mb-4 max-w-[240px] lg:ml-auto">
              Your trusted Partner for premium antique clothing, handicrafts,
              and shawls.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by Global Supply 600.
            </p>
