...
const Header = () => {
  ...
  const options = [
    ...
    { label: "Women's Dresses & Abayas", value: "Women's Dresses & Abayas" },
    { label: "Women's Tops & Sets", value: "Women's Tops & Sets" },
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0 flex items-center gap-3" href="/">
              <Image
                src="/images/logo/logo-gs600.png"
                alt="Global Supply 600"
                width={52}
                height={52}
                className="rounded-full"
              />
              <span className="hidden sm:block font-serif font-semibold text-lg leading-none text-dark">
                Global Supply 600
              </span>
            </Link>
