...
const config: Config = {
  ...
  theme: {
    fontFamily: {
      "euclid-circular-a": ["var(--font-sans)", "sans-serif"],
    ...
    colors: {
      ...
      // Primary accent — antique burgundy (mapped onto the template's `blue`
      // token so existing bg-blue/text-blue usages adopt the new brand color).
      blue: {
        DEFAULT: "#7A2E35",
        dark: "#5C1F27",
        light: "#9C4A50",
      ...
      // Antique gold accent (available for premium detailing).
      gold: {
        DEFAULT: "#B08D57",
        dark: "#8C6D3F",
        light: "#C9A876",
